...
<div id="footer" class="footer flex bg-black/60 {textColor} w-full self-end font-display text-base flex align-middle items-center justify-between h-20 relative z-20">
