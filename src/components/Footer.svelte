...
<div id="footer" class="footer flex bg-blueGray-800 border-t-2 border-blueGray-600 {textColor} w-full self-end font-display text-base flex align-middle items-center justify-between h-20 relative z-20">
